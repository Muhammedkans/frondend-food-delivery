  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // ✅ Check if role is restaurant
        if (user.role !== "restaurant") {
          toast.error("You are not authorized as a restaurant!");
          setLoading(false);
          return;
        }
    ...
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="w-full max-w-md p-8 bg-[#111111] rounded-2xl shadow-lg border border-gray-800">
        ...
        <p className="mt-4 text-gray-400 text-center">
          ...
          <Link to="/auth/restaurant-register" className="text-green-400 hover:underline">
            Register
          </Link>
        </p>
      </div>
